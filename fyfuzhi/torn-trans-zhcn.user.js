...
<input style="-webkit-appearance:none;padding: 4px;background: #009688;border-radius: 5px;color: white;" type="submit" value="偷夹克" />
        ...
        // console.log(cIframe.contentWindow.document.readyState);
        // cIframe.contentWindow.document.onreadystatechange = () => console.log(cIframe.contentWindow.document.readyState);
        // 加载状态
            ...
            if (ifWH === undefined) {
                ...
                elementReady('.content-wrapper', ifDocu).then(e => {
                    ...
                    new MutationObserver(() => {
                        if (!e.querySelector('.wh-translate')) e.prepend(mobile_prepend_node);
                    })
